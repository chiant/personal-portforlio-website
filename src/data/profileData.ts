...
import profileDataJson from '../../data/profile-data.json';

// Type assertion to ensure the imported JSON matches our ProfileData interface
export const profileData: ProfileData = profileDataJson as ProfileData;
